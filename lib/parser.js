...
var urlMatchRegex = /\s(href|accesskey|background|cite|classid|codebase|data|longdesc|profile|src|usemap|itemtype|srcset|link)=("|')([^"']+)/g 
...
function fetchAndParse(protocol, host, completeUrl, headers, cb){
    ...
    request(options, function (error, response, body) {
        ...
        if(error){
            //console.log(error)
            console.log(completeUrl+ ' error occurred')
